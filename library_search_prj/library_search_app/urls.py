...
urlpatterns = [
    ...
    path('board_update/<int:pk>/', board_update, name='board_update'),
    path('board_delete/<int:pk>/', board_delete, name='board_delete'),
    path('board_view/<int:pk>/', BoardView.as_view(), name='board_view'),
    path('board_list/<category>', board_list, name="board_list"),
    path('reply_write/<int:pk>', reply_write, name="reply_write"),
