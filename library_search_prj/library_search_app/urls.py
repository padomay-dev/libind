...
urlpatterns = [
    ...
    path('user_register_idcheck/', user_register_idcheck, name='user_register_idcheck'),
    path('user_register_result/', user_register_result, name='user_register_result'),
    path('user_register_completed/', user_register_completed, name='user_register_completed'),
